...
@click.option('-m', '--omit', default='.mapomit', help='Specify custom omit file.')
...
@click.pass_context
def generate_command(ctx, output, ignore, omit, header, footer, indent_char, arrow, ignore_hidden, max_size):
